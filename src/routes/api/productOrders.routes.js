...
router.post('/', authMiddleware, checkRole(['buyer','seller','admin']), getUsercart, createOrder) 
...
router.post('/address/:id', authMiddleware,  addressProfile, checkRole(['buyer','seller','admin']), addOrderAddress) 
